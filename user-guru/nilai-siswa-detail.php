                ...
                <div class="row my-3">
                    ...
                    <div class="d-flex mb-3">
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <a class="btn btn-warning" href="..\user-guru\tambah-nilai-detail.php?tahun_ajaran=<?= $tahun; ?>&id_kelas=<?= $kelas ?>&id_kbm=<?= $kbm ?>&id_user=<?= $id; ?>&id_mapel=<?= $mapel ?>">TAMBAH NILAI</a>
                            </div>
                        </div>
                    </div>
                    <div class="col mt-1">
                                        ...
                                        if ($result && $result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) { ?>
                                                <tr>
                                                    ...
                                                    <td> <?= $row["poin"]; ?></td>
                                                    <td>
                                                        <a class="btn btn-danger" id="btnHapusData">🗑</a>
                                                    </td>
                                                </tr>
                                        <?php }
                                        } ?>
