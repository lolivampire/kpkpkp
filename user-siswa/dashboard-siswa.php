    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="../user-siswa/dashboard-siswa.php" class="list-group-item list-group-item-action bg-transparent second-text active"><em class="fas fa-tachometer-alt me-2"></em>Dashboard</a>
                <a href="../user-siswa/nilai.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><em class="fas fa-project-diagram me-2"></em>Penilaian</a>
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle second-text fw-bold" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <em class="fas fa-user me-2"></em> Selamat Datang,
                                <?php
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded shadow-lg">
                            <div>
                                ...
                                <p class="fs-5">Mapel Terdaftar</p>
                            </div>
