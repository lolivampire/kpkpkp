        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">HALAMAN NILAI SISWA</h2>
                </div>
            ...
            <div class="container-fluid px-4">
                <div class="row my-3">
                    <h3 class="fs-4 mb-3">Nilai Siswa</h3>
                        ...
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table bg-white rounded shadow-lg  table-hover" id='tabel_nilai'>
                                    ...
                                    <tbody>
                                        <?php
                                        $result = $funss->siswaGetJumlahNilai($kbm, $idU);
                        ...
                        <div class="card shadow-lg my-3">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table bg-white rounded shadow-lg  table-hover" id='tabel_nilai'>
                                    ...
                                    <tbody>
                                        <?php
                                        $result = $funs->getNilaiSiswaFromDetail($idU, $kbm);
                                        if ($result && $result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) { ?>
                                                <tr>
